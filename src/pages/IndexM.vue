    ...
    <q-page-container>
      <q-page>
        <q-carousel
          ...
          id="id_idx"
        >
          <q-carousel-slide class="q-pa-none" :name="1" :img-src="index_image_1">
            <div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
              <div class="custom-caption">
                <div class="text-h6 main_line animation_2">奥格莱 </div><br><br>
                <div class="text-h6 main_line animation_2"><span :style="'color:'+theme_color">AoGeLai</span></div><br><br>
                <div class="text-h6 animation_1">奥格莱为您提供最优质的产品与服务</div><br><br><br>
                <div class="animation_2">
                  <q-btn size="lg" :style="'background:'+ theme_color +'; color: white'" @click="jumpToIndex('t_1');" label="了解我们"/>
                </div>
              </div>
            </div>
          </q-carousel-slide>
          <q-carousel-slide class="q-pa-none" :name="2" :img-src="index_image_2">
            <div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
              <div class="custom-caption">
                <div class="text-h6 main_line animation_2">为客户</div><br><br>
                <div class="text-h6 main_line animation_2"><span :style="'color:'+theme_color">精心设计</span></div><br>
                <div class="text-h6 animation_1">最适合您的解决方案！</div><br><br>
                <div class="animation_2">
                  <q-btn size="lg" :style="'background:'+ theme_color +'; color: white'" @click="jumpToIndex('t_1');" label="了解我们"/>
                </div>
              </div>
          ...
          <q-carousel-slide class="q-pa-none" :name="3" :img-src="index_image_3">
            <div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2">多种 </div><br><br>
                <div class="text-h2 main_line animation_2"><span :style="'color:'+theme_color">高性能门</span></div><br><br>
                <div class="text-h4 animation_1">供您挑选！</div><br><br>
                <div class="animation_2">
                  <q-btn size="lg" :style="'background:'+ theme_color +'; color: white'" @click="jumpToIndex('t_1');" label="了解我们"/>
                </div>
              </div>
        ...
        <div class="quote" id="id_about_us" >
          <div class="q-pt-xl full-width full-height flex flex-center" style="color: black">
            <div class="row">
              <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                <h3 class="text-center">公司概况
                </h3>
              </div>
            </div>
            <div class="row">
              <h5 class="text-left" style="margin-left:10%; margin-right:10%; font-size: medium;">
                &emsp;&emsp;广东奥格莱节能环保科技有限公司专注于工业门贸易、生产、安装及售后服务。<br>
                &emsp;&emsp;我们是中国改革开放后最早从事提供工业门类设备和物流服务的企业，积累了丰富的经验。<br>
                &emsp;&emsp;公司运营近15年，于2005年开始规模化和网络化发展，在全国多个大中城市建立了专业的营销、安装及售后服务中心和网点。
              </h5>
            </div>
          </div>
          <div class="q-pt-xl full-width full-height" style="color: black">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h3 class="text-center">视频介绍
              </h3>
              </div>
            <div class="col q-pa-lg">
              <video
                controls
                src="/statics/videos/505.mp4"
                style="width: 100%;"
              >
              </video>
            </div>
        ...
        <div class="quote" id="id_portfolio">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h3 class="text-center">产品介绍
              </h3>
            </div>
          </div>
          <q-carousel
            animated
            v-model="slide_product"
            v-if="products"
            arrows
            swipeable
            navigation
            ...
            height="100%"
          >
            <q-carousel-slide class="q-pa-md" v-for="index in 6" :key="index" :name=index
              style="
            ...
            >
              <q-flashcard :no-hover="hover" :style="style">
                <q-flashcard-section transition="nudge-in" :active="active">
                  <img :src="products[index-1].image_path[0]" width=340 height=340>
                </q-flashcard-section>
                <q-flashcard-section transition="fade-in" class="fit" :active="active">
                  ...
                  <q-flashcard-section transition="slide-up-in" class="my-text" :active="active">
                    {{products[index-1].introduction}}
                  </q-flashcard-section>
                  <q-flashcard-section transition="fade-in" class="fit flex justify-center items-end q-pb-lg"
                                      :active="active">
                    <q-btn class="q-mr-md" :style="'color:'+theme_color" style="background-color:white" label='查看详情' @click="jumpToProduct(index)" />
                  </q-flashcard-section>
                </q-flashcard-section> -->
              </q-flashcard>
            </q-carousel-slide>
        ...
        <div class="quote" id="id_services">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h3 class="text-center text-black">工程案例
              </h3>
            </div>
          </div>
          <q-carousel
            animated
            v-model="slide_example"
            v-if="examples"
            arrows
            swipeable
            navigation
          ...
          >
            ...
            >
              ...
              >
                <img
                  :src="examples[index-1].image_path[0]" width=280 height=280
                />
                <q-card-section style="height: 90%;">
                  <div :class="'about_heading_'+index" :style="'color: about_heading_color_'+index" class="text-h6 q-mt-sm q-mb-xs">
                    {{examples[index-1].title}}
                  </div>
                  <div
                    style="
                      line-height: 20px;
                  ...
                  <div>
                    <q-btn @click="jumpToExample(index)" size="md" :style="'background:'+ theme_color +'; color: white'" label="详情"/>
                  </div>
                </q-card-section>
              </q-card>
            </q-carousel-slide>
        ...
        <div class="quote" id="id_news">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h3 class="text-center text-black">新闻资讯
              </h3>
              <br>
            </div>
          </div>
          <!-- <div class="row text-center flex flex-center quote"> -->
          <q-carousel
            animated
            v-model="slide_news"
            v-if="news"
            ...
            height="100%"
          >
            <q-carousel-slide class="q-pa-md" v-for="index in 3" :key="index" :name=index
              style="
                background: url(/statics/images/pure.jpeg);
                display: flex; 
                justify-content: center;
              "  
            >
              <q-card @mouseover="hoverOver(index)" @mouseout="hoverOutTimeout(1)" style="border: none; height: 100%;" class="my-card text-center box-shadow" flat bordered>
                <img
                  :src="news[index-1].image_path[0]" 
                  width=340
                  height=340
                />
                <q-card-section class="text-left" style="height: 100%;">
                  <div :class="'about_heading_'+index" :style="'color: ' + about_heading_color_1" class="text-h6 q-mt-sm q-mb-xs">
                    {{news[index-1].title}}
                  </div>
                  <b>{{news[index-1].time.split(' ')[0]}}</b>
                  <div 
                    style="
                      line-height: 20px;
                      overflow : hidden;
                      ...
                      -webkit-box-orient: vertical;
                    "
                    class="text-caption text-grey-9 q-mt-sm">
                    {{news[index-1].content}}
                  </div>
                  <div>
                    <q-btn @click="jumpToNews(index)" size="lg" :style="'background:'+ theme_color +'; color: white'" label="详情"/>
                  </div>
                </q-card-section>
              </q-card>
            </q-carousel-slide>
        ...
        <div class="contact_us" id="id_contact_us">
          <div style="background-color: #000000ad !important;">
            <div class="row" id="id_news">
              <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                <h3 class="text-center text-white">联系我们
                  <br>
                </h3>
                <h5 class="text-center text-white">
                  <span>我们会第一时间回复您的留言</span>
                  <br>
                </h5>
              </div>
            </div>
            <div class="row text-center flex flex-center q-pb-lg">
              <div class="col-md-6 col-lg-6 col-sx-12 col-sm-12 q-gutter-lg q-px-xl q-pb-none q-ma-none">
                <q-input bg-color="white" outlined label="您的姓名*" v-model="contact_name">
                  <template v-slot:append>
                    <q-icon name="event" :style="'color:' + theme_color" />
                  </template>
                </q-input>
                <q-input bg-color="white" outlined label="您的邮箱" v-model="contact_email">
                  <template v-slot:append>
                    <q-icon name="event" :style="'color:' + theme_color" />
                  </template>
                </q-input>
                <q-input bg-color="white" outlined label="您的电话*" v-model="contact_phone">
                  <template v-slot:append>
                    <q-icon name="event" :style="'color:' + theme_color" />
                  </template>
                </q-input>
              ...
              <div class="col-md-6 col-lg-6 col-sx-12 col-sm-12 q-gutter-lg q-px-xl q-pb-none q-ma-none">
                <q-input class="" type="textarea" bg-color="white" outlined label="您的留言 *" v-model="contact_message">
                  <template v-slot:append>
                    <q-icon name="event" :style="'color:' + theme_color" />
                  </template>
                </q-input>
            ...
            <div class="row flex flex-center text-center q-pb-xl q-mt-md">
              <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12">
                <q-btn size="lg" :style="'background:'+ theme_color +'; color: white'" label="发送留言" @click="send_message"/>
              </div>
            </div>
          </div>
        </div>
        <q-toolbar class="flex flex-center text-white" style="background-color: #f7f7f7;" :style="'border-top: 2px solid '+ theme_color">
          <div class="q-pa-sm q-gutter-sm" style="color:black;">
            <br/>
            版权所有：广东奥格莱节能环保科技有限公司 
            <br/>
            地址: 广州市荔湾区东漖北路鸿图东街13号二层 
            <br/>
            邮编: 510145 <a style="text-decoration:none;" href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2022113150号-1</a>
            <br/>
            电话: 17620840519 <a style="text-decoration:none;" href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2022113150号-1</a>
      	  </div>
        </q-toolbar>
      </q-page>
    </q-page-container>
...
export default {
  ...
  data() {
    return {
      ...
      about_heading_color_4: '#424242',
      about_heading_color_5: '#424242',
      about_heading_color_6: '#424242',
    }
  },
  beforeMount() {
    this.getProducts()
  ...
  methods: {
    listItemStyle(i) {
      let style = {}
      style.color = 'about_heading_color_' + i
      style.fontSize = 15
      return style
    },
    getParams() {
      let that = this
      if (this.$route.query.selected_tab) {
        if (this.$route.query.selected_tab == 't_5') {
          setTimeout(() => {
            this.selected_tab = 't_5'
            that.scrollToElement('id_contact_us')
          }, 500)
        }
        if (this.$route.query.selected_tab == 't_1') {
          setTimeout(() => {
            this.selected_tab = 't_1'
            that.scrollToElement('id_about_us')
          }, 500)
        }
      }
    },
    ...
    jumpToIndex(e) {
      this.selected_tab = e
      if (e == 't_0') {
        this.scrollToElement('id_idx')
      }
      if (e == 't_5') {
        this.scrollToElement('id_contact_us')
      }
      if (e == 't_1') {
        this.scrollToElement('id_about_us')
      }
    }
  }
}
